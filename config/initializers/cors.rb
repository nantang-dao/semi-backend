Rails.application.config.middleware.insert_before 0, Rack::Cors do
  allow do
    ...
    origins "https://semi.fly.dev", "https://semi-production.fly.dev", "https://semi.ntdao.xyz", "https://app.ntdao.xyz", "https://semi.im", "https://www.semi.im", "https://web.semi.im", "http://localhost:3001", "http://localhost:3000"
